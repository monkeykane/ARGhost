...
public class HiARPaint : MonoBehaviour
{
    ...
    private HiARTargetMonoBehaviour hiarTarget = null;
    ...
    void Start()
    {
        ...
        hiarTarget = GetComponentInParent<HiARTargetMonoBehaviour>();
        targetHalfSize = new Vector2(hiarTarget.NFTPixelWidth, hiarTarget.NFTPixelHeight) * 0.5f;
    ...
    void Init()
    {
        Texture2D texture = engine.CameraTexture;
